...
import {registro,errorRegistro,login,errorLogin,addProducts,changePassword,nodemailerPassword,jwt,profileAddDocuments,carShop,panelUsers} from '../controllers/views.controller.js'
...
router.get('/carShop',carShop)

router.get('/usersPanel',isAdmin,panelUsers)
